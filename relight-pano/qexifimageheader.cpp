    ...
    : d( qExifValuePrivateSharedNull() )
{
    ...
    case JisEncoding:
    {
		throw QString("Unsupported JISEncoding");
	//	auto codec = QStringConverter::encodingForName( "JIS X 0208" );
	  //  if( codec )
    ...
    {
		//auto codec = QStringConverter::encodingForName( "UTF-16" );
	  //  if( codec )
			d = new QExifUndefinedValuePrivate( QByteArray::fromRawData( "UNICODE\0", 8 ) + value.toUtf8());
    }
        break;
...
QString QExifValue::toString(QSysInfo::Endian byteOrder) const
{
    ...
    case Undefined:
    {
        ...
        case JisEncoding:
        {
			throw QString("Unsupporting JIS");
